        ...
        <CardContent sx={{
          ...
          <Grid item xs={12}>
            <FormControl fullWidth>
              ...
              <FormHelperText id="tarefa_titulo_helper_text">Task Title</FormHelperText>
            </FormControl>
          </Grid>
          <Grid item xs={12}>  
            <FormControl fullWidth>
              ...
              <FormHelperText id="tarefa_descricao_helper_text">Task Description</FormHelperText>
            </FormControl>
          </Grid>
          <Grid container spacing={2} mt={1}>
            <Grid item xs={3}>  
              <FormControl>
                ...
                />
                <FormHelperText id="tarefa_inicio_helper_text">Task Start</FormHelperText>
              </FormControl>
            </Grid>  
            <Grid item xs={3}>  
              <FormControl>
                ...
                />
                <FormHelperText id="tarefa_fim_helper_text">End Task</FormHelperText>
              </FormControl>
            </Grid>
            <Grid item xs={3}>  
              <FormControl fullWidth>
                <InputLabel htmlFor="tarefa_recurso">Recurse</InputLabel>
                <Select
                  id="tarefa_recurso"
                  value={recursoTarefa}
                  label="Recurso"
                ...
                >
                  <MenuItem value={'Recurso 1'}>Recurse 1</MenuItem>
                  <MenuItem value={'Recurso 2'}>Recurse 2</MenuItem>
                  <MenuItem value={'Recurso 3'}>Recurse 3</MenuItem>
                </Select>
              </FormControl>
            </Grid>
            <Grid item xs={3}>  
              <FormControl fullWidth>
                ...
                >
                  <MenuItem value={'Aguardando'}>Waiting</MenuItem>
                  <MenuItem value={'Em Andamento'}>In Progress</MenuItem>
                  <MenuItem value={'Concluída'}>Concluded</MenuItem>
                </Select>
              </FormControl>
            </Grid>
            <Grid container spacing={2} pl={2} mt={2}>
              <Grid item xs={1}>
                <Button size="small" variant="contained" onClick={handleEditar}>Save</Button>
              </Grid>  
              <Grid item xs={1}>  
                <Button size="small" variant="outlined" onClick={handleCloseEditar}>Cancel</Button>  
              </Grid>
            </Grid>  
          </Grid>
        </CardContent>
